...
public class EditarDomicilio extends javax.swing.JFrame {
    ...
    public EditarDomicilio(int idVenta) {
        this();
    ...
    private void initComponents() {
        ...
        deliveryText.setText("Editar Domicilio");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        String add = "update domicilio "
                + " set dom_dirEntrega = ?, dom_estado = ?, dom_precio = ?, Empleado_emp_id  = ?, Barrio_bar_id  = ?"
                + " where Venta_ven_id = ?";
        PreparedStatement s;
        try {
    ...
    private void cargarDatos() {
        String empleado = "";
        String search_emp = "select per_nombre"
                + " from empleado join domicilio on (emp_id = Empleado_emp_id)"
        ...
        try {
            ...
            ResultSet resultadoe = e.executeQuery();
            resultadoe.next();
            empleado = resultadoe.getString(1);
        } catch (SQLException ex) {
            Logger.getLogger(EditarDomicilio.class.getName()).log(Level.SEVERE, null, ex);
        }

        String barrio = "";
        String search_bar = "select bar_nombre"
                + " from barrio join domicilio on (bar_id = Barrio_bar_id)"
                + " where Venta_ven_id = ?;";
        ...
        try {
            ...
            ResultSet resultadob = b.executeQuery();
            resultadob.next();
            barrio = resultadob.getString(1);
        } catch (SQLException ex) {
            Logger.getLogger(EditarDomicilio.class.getName()).log(Level.SEVERE, null, ex);
        }

        String consulta = "select dom_dirEntrega, dom_estado, dom_precio, Empleado_emp_id, Barrio_bar_id"
                + " from domicilio where Venta_ven_id = ?;";
        PreparedStatement s;
        try {
            ...
            estadoComboBox.setSelectedItem(resultado.getString(2));
            precioFormattedTextField.setValue(resultado.getInt(3));
            empleadoComboBox.setSelectedItem(empleado);
